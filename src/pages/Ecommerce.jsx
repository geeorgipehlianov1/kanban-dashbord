...
import { Stacked, Pie, Button, SparkLine, Cart } from '../components'
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="p-1.5 hover:drop-shadow-xl text-xs cursor-pointer rounded-full text-white bg-green-400 ml-3">
                    23%
                  </span>
                </p>
